// Liste complete des pays du monde (noms francais), triee alphabetiquement.
// Partagee entre FilmsPage et SeriesPage pour le champ "Pays d'origine".
export const COUNTRIES = [
  ...
  'Sainte-Lucie', 'Salvador', 'Samoa', 'Sao Tomé-et-Principe', 'Sénégal',
